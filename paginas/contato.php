<main class="main-contato">
    <div class="formas-contato">
        <div class="opcao-1">
            ...
            <form data-aos="zoom-in" data-parsley-validate>
                ...
                <br>
                <input name="nome" type="text" placeholder="Ex: Nome" required required
                    data-parsley-required-message="Digite um nome!">
                <br>
                <br>
                <label for="numb">Nº de telefone:</label>
                <br>
                <input id="tel" class="tel" name="telefone" type="text" placeholder="Ex: (99) 99999 9999" required
                ...
                <button type="" id="btn-whatsapp" class="btn btn-success btn-lg">Enviar <img
                        src="/SITE-Barber/imgs/whatsapp.png" alt=""></button>
            </form>
        </div>
        <div class="opcao-ou">
            <p>Ou</p>
    ...
    <div class="opcao-2-desktop">
        <img src="\SITE-Barber\imgs\opcao-2-desktop.jpg" alt="">
        <a href="https://sites.appbarber.com.br/pt-br/goldenline" class="btn btn-primary btn-lg">Agendar</a>
    </div>
    <div class="opcao-2-mobile">
        <img src="\SITE-Barber\imgs\ad-mobile.jpg" alt="">
    </div>
    </div>
</main>
<script>
